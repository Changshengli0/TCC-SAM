...
run_eval () {
  ...
  OUT=./output/eval_807958_push81_${NAME}
...
run_eval B_current 0.08 0.03
run_eval D_wider1  0.10 0.03
run_eval E_wider2  0.12 0.03
run_eval F_relax1  0.10 0.05
run_eval G_relax2  0.12 0.05

echo ""
echo "================ Push-81 gate sweep summary ================"
for NAME in B_current D_wider1 E_wider2 F_relax1 G_relax2; do
  LOG=output/eval_807958_push81_${NAME}/run_0/log.txt
  echo "----- ${NAME} -----"
